...
The lack of interpretability and transparency within LLMs makes it difficult for human reasoning alone to determine whether or not significant data can be extracted from a model’s intermediate activations. The black-box nature of how those activations were computed makes deep learning the ideal tool to analyze them and overcome that limitation. Not only would this type of data be otherwise illegible, but the practical value of accomplishing less with more in terms of smaller models with less computational complexity was a worthy goal when the current trend in deep learning is models getting bigger and more expensive to perform “better”. By applying deep learning in this manner, we can demonstrate how a narrower focus with smaller models can be taken advantage of to expand the field. 
